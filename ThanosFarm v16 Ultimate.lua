...
--// =========================
--// WEAPON PRIORITY GUI ADDON
--// =========================
-- This does NOT modify your existing script logic.
-- It only displays the WEAPON_PRIORITY table already used in your script.
...
task.spawn(function()
    ...
    title.Text = "Weapon Priority (Strongest → Weakest)"
    ...
    box.Text = "Loading weapon priority..."
    box.Parent = frame

    task.wait(2)

    if WEAPON_PRIORITY then

        local txt = ""

        for i,v in ipairs(WEAPON_PRIORITY) do
        ...
        box.Text = "WEAPON_PRIORITY table not found."
